...
`outputs/claude-income-source-verification.md` against the implemented and
...
| Release-curriculum parity | deterministic title, order, lesson-minute, unit-title, and 895-minute checks against `outputs/claude-income-curriculum-draft.md` | PASS; all 4 units and all 12 lessons match the implemented data |
