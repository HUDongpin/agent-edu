...
export const AGENT_ORCHESTRATION_ZH_HANS_COPY = {
  ...
  ui: {
    ...
    restoringProgress: "正在恢复此浏览器中的学习进度…",
    storageCorrupt: "浏览器中的共享学习记录无法读取。原始数据已保持不变；请先下载恢复副本，再前往“我的学习”使用全站恢复工具。",
    storageQuotaExceeded: "浏览器存储空间不足，无法安全保存新的学习内容。当前未保存内容可先下载恢复副本。",
    storageUnavailable: "此浏览器目前拒绝本地存储。为避免显示虚假进度或丢失内容，课程操作暂时停用。",
    downloadRecovery: "下载恢复副本",
    openRecoveryTools: "打开“我的学习”恢复工具",
    recoveryDownloaded: "恢复副本已下载；原始浏览器记录仍未更改。",
    recoveryUnavailable: "没有可下载的恢复数据。",
    workspaceEyebrow: "跨设备工作区",
    workspaceTitle: "导出或恢复课程 15 工作",
    workspaceLocal: "本地文件 · 不上传",
    workspaceIntro: "导出只包含课程 15 拥有的字段。恢复会先预览，只添加本地尚不存在的字段；已有或更新的本地工作永不被静默覆盖。",
    exportWorkspace: "导出工作区",
    chooseWorkspace: "选择恢复文件",
    workspaceRejected: "未接受此文件",
    restorePreview: "恢复预览",
    workspaceAdd: "将添加",
    workspaceSame: "已相同",
    workspaceKeep: "保留本地",
    workspaceConflicts: "查看保留的本地字段",
    applyWorkspace: "恢复新内容（{add}）",
    workspaceRestored: "恢复完成：新增 {applied} 项；保留本地 {skipped} 项。",
    workspaceRestoreFailed: "无法验证恢复写入；现有浏览器记录保持不变。",
    migrationPreserved: "课程更新已保留 {preserved} 项学习内容；{invalidated} 项旧收据需要重新核验。",
    capstoneRecoveryPending: "课程更新已恢复这些引用，但尚未把旧收据视为完成证据。请逐项核对并重新保存。",
    resetComplete: "课程 15 进度已在此浏览器重置",
    resetFailed: "无法验证重置；原有浏览器记录保持不变。",
    resetMemory: "课程 15 进度已在当前标签页重置",
    cancelReset: "取消",
    resetConfirmationOpen: "重置确认将在 {seconds} 秒内有效。请立即确认或取消。",
    resetCancelled: "已取消重置。学习进度未发生更改。",
    resetExpired: "重置确认已过期。学习进度未发生更改。",
    ...
    tryAgain: "请重新判断这条边界",
    saveLab: "保存实验状态",
    labReadyToSave: "情境与解释已就绪；请等待草稿保存，或显式保存为证据。",
    inProgress: "进行中",
    ...
    assessmentOf: "共",
    assessmentReadyToGrade: "全部题目已作答，可以提交评分。",
    assessmentResultTitle: "测验结果",
    assessmentWorkspaceTitle: "检查你的架构决策",
    assessmentQuestionsToReview: "需要复习的题目",
    assessmentCorrectAnswer: "正确答案",
    assessmentReviewModule: "复习模块",
    assessmentRetryAction: "重新作答",
    assessmentOptionSelected: "已选择",
    assessmentOptionSelectedCorrect: "已选择 · 正确",
    assessmentOptionCorrect: "正确答案",
    assessmentOptionSelectedMissed: "你的答案 · 需复习",
    releaseContract: "发布契约",
    auditableArtifacts: "15 项可审计交付物",
    capstoneOpen: "每项交付物都有证据之前，综合项目不能标记完成。",
    capstoneReviewFirst: "检查第一个未解决的交付物",
    capstoneAllResolved: "所有证据字段均已通过本地格式与唯一性检查。",
    evidenceRequired: "请为此交付物添加证据引用。",
    evidenceTooLong: "请把引用缩短至 2,048 个字符以内。",
    evidenceUnsupportedScheme: "请使用 HTTPS，或允许的 trace、review、ticket、file、artifact 标识符。",
    evidenceTooShort: "请添加至少包含八个有效字符的具体引用。",
    evidencePlaceholderReason: "请用真实证据引用替换占位符或示例文字。",
    evidenceMissingIdentifier: "请添加稳定 URL、文件扩展名，或 trace、ticket、review 标识符。",
    evidenceDuplicate: "请使用不同引用；这项证据已分配给另一交付物。",
    evidenceAccepted: "该引用已通过本地格式与唯一性检查。",
  ...
  modules: {
    "workflow-agent-boundary": {
      ...
      checkpoint: {
        checkpointId: "ao15.workflow-agent-boundary.zh-hans.multi-agent-justification",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "什么情况最能证明应从单智能体升级为多智能体？",
        options: [
          { id: "advanced-demo", label: "团队希望产品演示看起来更先进。" },
          { id: "more-role-names", label: "可以创建更多角色名称。" },
          { id: "measured-isolation-parallel-benefit", label: "经评估证实上下文隔离或独立并行显著提高任务成功率，并且新增控制与恢复成本可接受。" },
          { id: "occasional-latency", label: "单次调用偶尔回答得慢。" },
        ],
        correctOptionId: "measured-isolation-parallel-benefit",
        explanation:
    ...
    "task-graphs-contracts": {
      ...
      checkpoint: {
        checkpointId: "ao15.task-graphs-contracts.zh-hans.ambiguous-external-write",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "一个外部写入节点超时后，哪种图设计最可靠？",
        options: [
          { id: "mark-failed-retry-forever", label: "立即把节点标为 failed 并无限重试。" },
          { id: "chat-summary-as-state", label: "把聊天摘要当作最终状态。" },
          { id: "outcome-unknown-reconcile", label: "进入 outcome_unknown，先通过效果账本或外部查询核对，再决定确认、补偿或人工对账。" },
          { id: "downstream-guesses", label: "让下游节点猜测写入是否成功。" },
        ],
        correctOptionId: "outcome-unknown-reconcile",
        explanation:
    ...
    "chaining-routing": {
      ...
      checkpoint: {
        checkpointId: "ao15.chaining-routing.zh-hans.structured-output-boundary",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "关于 Structured Outputs，哪项说法正确？",
        options: [
          { id: "schema-proves-truth-authorization", label: "只要 JSON 符合模式，分类就一定真实且行动已获授权。" },
          { id: "shape-only-application-checks", label: "模式约束可支持输出形状，但真值、授权、安全及 refusal/incomplete 仍需应用处理。" },
          { id: "replaces-policy", label: "结构化输出可以替代所有代码政策。" },
          { id: "max-authority-fallback", label: "模式错误时应默认选择权限最大的目的地。" },
        ],
        correctOptionId: "shape-only-application-checks",
        explanation:
    ...
    "parallel-fanout-fanin": {
      ...
      checkpoint: {
        checkpointId: "ao15.parallel-fanout-fanin.zh-hans.tool-call-intents",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "模型在一个响应中返回三个 function calls，能直接推导出什么？",
        options: [
          { id: "three-concurrent-agents", label: "三个完整智能体正在并行运行。" },
          { id: "tool-intents-runtime-decides", label: "模型提出了多个工具调用；是否以及如何并发执行、共享状态和处理失败仍由具体 SDK/应用决定。" },
          { id: "exactly-once-effects", label: "外部副作用必定 exactly-once。" },
          { id: "no-concurrency-budget", label: "无需设置并发预算。" },
        ],
        correctOptionId: "tool-intents-runtime-decides",
        explanation:
    ...
    "manager-roles-ownership": {
      ...
      checkpoint: {
        checkpointId: "ao15.manager-roles-ownership.zh-hans.final-answer-owner",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "在经理调用专家模式中，谁通常拥有最终用户回答？",
        options: [
          { id: "last-specialist", label: "最后一个完成的专家。" },
          { id: "central-manager", label: "中央经理；专家返回有界产物供其综合。" },
          { id: "specialist-host", label: "运行专家的 Host。" },
          { id: "largest-capacity-process", label: "并发槽位最多的进程。" },
        ],
        correctOptionId: "central-manager",
        explanation:
    ...
    "delegation-handoffs": {
      ...
      checkpoint: {
        checkpointId: "ao15.delegation-handoffs.zh-hans.control-transfer",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "哪项最准确地区分 agents-as-tools 与 handoff？",
        options: [
          { id: "parallel-versus-sequential", label: "前者一定并行，后者一定顺序。" },
          { id: "manager-retains-versus-recipient-control", label: "前者由经理保留控制并综合专家结果；后者把后续控制交给接收者。" },
          { id: "model-versus-no-model", label: "前者不使用模型，后者只使用模型。" },
          { id: "vendor-synonyms", label: "两者完全相同，只是不同厂商命名。" },
        ],
        correctOptionId: "manager-retains-versus-recipient-control",
        explanation:
    ...
    "orchestrator-workers-verification": {
      ...
      checkpoint: {
        checkpointId: "ao15.orchestrator-workers-verification.zh-hans.systematic-omission",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "怎样让验证者更可能发现工作者的系统性遗漏？",
        options: [
          { id: "worker-self-summary-only", label: "只把工作者的自我总结交给验证者。" },
          { id: "same-role-produce-approve-release", label: "让同一角色同时产出、批准和发布。" },
          { id: "primary-requirements-rubric-evidence", label: "让验证者读取原始需求、外部量规和抽样原始证据，并限制其写入权限。" },
          { id: "remove-stop-budget", label: "取消所有停止预算。" },
        ],
        correctOptionId: "primary-requirements-rubric-evidence",
        explanation:
    ...
    "tools-aci-mcp": {
      ...
      checkpoint: {
        checkpointId: "ao15.tools-aci-mcp.zh-hans.versioned-protocol-scope",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "关于 MCP 2026-07-28，哪项表述最准确？",
        options: [
          { id: "complete-orchestration-suite", label: "MCP 本身提供任务分解、长期记忆、沙箱和评估。" },
          { id: "legacy-academy-authority", label: "旧 Claude Academy MCP Advanced 课程是当前规范的最高依据。" },
          { id: "versioned-capability-exchange", label: "MCP 标准化能力交换；当前实现应以 2026-07-28 规范及匹配 SDK 为准，旧课程只作迁移对照。" },
          { id: "schema-equals-authorization", label: "工具 schema 已经等同于用户授权。" },
        ],
        correctOptionId: "versioned-capability-exchange",
        explanation:
    ...
    "context-state-memory": {
      ...
      checkpoint: {
        checkpointId: "ao15.context-state-memory.zh-hans.business-source-of-truth",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "哪项最适合作为订单编排的业务真相？",
        options: [
          { id: "compacted-chat-summary", label: "模型对聊天的压缩摘要。" },
          { id: "agent-completion-claim", label: "最后一个智能体说“已经完成”。" },
          { id: "application-order-state-ledger-version", label: "应用控制的结构化订单状态，并关联效果账本和版本。" },
          { id: "current-context-window", label: "当前上下文窗口中的所有消息。" },
        ],
        correctOptionId: "application-order-state-ledger-version",
        explanation:
    ...
    "budgets-concurrency-stopping": {
      ...
      checkpoint: {
        checkpointId: "ao15.budgets-concurrency-stopping.zh-hans.concurrency-counting-scope",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "文档写“最大并发 3”时，下一步最重要的是什么？",
        options: [
          { id: "apply-three-everywhere", label: "立即把所有框架都设为 3。" },
          { id: "verify-runtime-version-counting-queue", label: "核对运行时、版本、计数对象、是否包含 root、是否按整树统计及排队语义。" },
          { id: "three-hosts", label: "把 Host 数量也固定为 3。" },
          { id: "remove-task-budget", label: "取消任务级预算。" },
        ],
        correctOptionId: "verify-runtime-version-counting-queue",
        explanation:
    ...
    "reliability-recovery": {
      ...
      checkpoint: {
        checkpointId: "ao15.reliability-recovery.zh-hans.ambiguous-write-timeout",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "外部写入请求超时后，最安全的第一步是什么？",
        options: [
          { id: "repeat-new-request-id", label: "立即用新请求 ID 重复执行。" },
          { id: "outcome-unknown-original-key-reconcile", label: "把操作标为 outcome_unknown，使用原幂等键查询效果账本/外部系统，再决定下一步。" },
          { id: "model-guess", label: "让模型猜测成功概率。" },
          { id: "delete-log", label: "删除失败日志以便重新开始。" },
        ],
        correctOptionId: "outcome-unknown-original-key-reconcile",
        explanation:
    ...
    "security-authority-human-control": {
      ...
      checkpoint: {
        checkpointId: "ao15.security-authority-human-control.zh-hans.human-approval-boundary",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "人工批准一次工具调用能够证明什么？",
        options: [
          { id: "result-correct", label: "工具结果一定正确。" },
          { id: "task-quality-passed", label: "整个任务质量已经通过。" },
          { id: "contextual-action-authorization", label: "在当时上下文和政策下，该批准者允许这次行动；正确性与最终责任仍需另行验证。" },
          { id: "permanent-child-permission", label: "所有子智能体永久获得相同权限。" },
        ],
        correctOptionId: "contextual-action-authorization",
        explanation:
    ...
    "tracing-observability-economics": {
      ...
      checkpoint: {
        checkpointId: "ao15.tracing-observability-economics.zh-hans.trace-evidence-scope",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "一条完整 trace 能证明什么？",
        options: [
          { id: "result-correct", label: "任务结果一定正确。" },
          { id: "execution-path-only", label: "它提供一次执行路径的证据；质量仍需评估，授权责任需审计，服务健康需聚合监控。" },
          { id: "privacy-complete", label: "系统已满足所有隐私要求。" },
          { id: "cost-optimal", label: "成本已经最优。" },
        ],
        correctOptionId: "execution-path-only",
        explanation:
    ...
    "evaluation-regression-evolution": {
      ...
      checkpoint: {
        checkpointId: "ao15.evaluation-regression-evolution.zh-hans.multiple-trials",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "为什么智能体评估通常需要多次 trial？",
        options: [
          { id: "trace-storage", label: "因为一次 trace 无法保存。" },
          { id: "estimate-behavior-distribution", label: "因为概率性行为会产生分布；多次试验才能估计稳定性、尾部失败和版本差异。" },
          { id: "more-private-data", label: "为了让评分器看到更多隐私数据。" },
          { id: "version-lock-unimportant", label: "因为版本锁不重要。" },
        ],
        correctOptionId: "estimate-behavior-distribution",
        explanation:
    ...
    "production-orchestration-capstone": {
      ...
      checkpoint: {
        checkpointId: "ao15.production-orchestration-capstone.zh-hans.background-mode-scope",
        contentVersion: AGENT_ORCHESTRATION_CHECKPOINT_CONTENT_VERSION,
        question: "关于 OpenAI Background mode，哪项说法正确？",
        options: [
          { id: "transaction-workflow-engine", label: "它自动成为跨服务的完整事务工作流引擎。" },
          { id: "single-async-response", label: "它在文档所述存储与保留约束内管理一个异步长响应；多步骤业务状态、效果账本与补偿仍需应用负责。" },
          { id: "exactly-once-webhook", label: "它保证 webhook 只投递一次。" },
          { id: "no-version-storage-constraints", label: "它消除了版本和存储约束。" },
        ],
        correctOptionId: "single-async-response",
        explanation:
