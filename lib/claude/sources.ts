...
export const CLAUDE_SOURCES = [
  ...
  official({
    ...
    note: "Supports dated first-party interface figures. Reuse is limited to educational identification and commentary pending written permission.",
  }),
  official({
    id: "academy-files",
    ...
    reuseMode: "asset-reused",
    note: "Supports the guided file workflow and one dated Academy interface figure.",
  }),
  official({
    id: "academy-projects",
  ...
  official({
    ...
    reuseMode: "asset-reused",
    note: "Supports dated first-party artifact figures; the lesson distinguishes Artifacts from generated office files.",
  }),
  official({
    id: "academy-research",
  ...
  official({
    ...
    reuseMode: "asset-reused",
    note: "Supports dated interface figures; permission behavior is cross-checked against current Help Centre guidance.",
  }),
  official({
    id: "academy-cowork",
    ...
    reuseMode: "asset-reused",
    note: "Surface availability is volatile; the lesson uses current Help Centre caveats and manual approvals.",
  }),
  official({
