...
export const RESPONSIBLE_AI_CAPSTONE_ARTIFACTS = [
  ...
  { id: "assurance-card", sourceIds: ["model-cards", "datasheets", "nist-genai-profile"], copy: { en: { title: "Model, data, and system assurance card", description: "An original cross-linked card separating observed evaluation, source documentation, intended safeguards, excluded uses, limitations, monitoring, ownership, update triggers, and contradictions." }, zhHans: { title: "模型、数据与系统保障卡", description: "课程原创交叉链接卡，分开观测评估、来源文档、计划保障、排除用途、局限、监测、负责人、更新触发器与矛盾。" } } },
