...
(function(){
  ...
  function show(name, opts){
    ...
    // A section control must not keep moving between pointerdown and pointerup:
    // Firefox and WebKit otherwise retarget a rapid second click to the panel.
    if (!opts.silent && window.scrollY>120) window.scrollTo({top:0,behavior:'instant'});
