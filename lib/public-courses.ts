...
const CATALOG_PRESENTATION_BY_ID = {
  ...
  "agentic-video-editing": { catalogOrder: 17, blurbKey: "c.agentic-video-editing.blurb", metaKey: "c.agentic-video-editing.meta", topic: "ai-systems", topicKey: "topic.aiSystems", level: "intermediate-to-advanced", levelKey: "c.agentic-video-editing.level", format: "project-based", formatKey: "cat.formatProject", minutes: 750, hue: "var(--gold)" },
  "responsible-ai": { catalogOrder: 18, blurbKey: "c.responsibleAi.blurb", topic: "responsible-ai", topicKey: "topic.responsibleAi", level: "beginner-to-intermediate", levelKey: "c.responsibleAi.level", format: "guided", formatKey: "cat.formatGuided", minutes: null, hue: "var(--red)" },
