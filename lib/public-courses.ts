...
const CATALOG_PRESENTATION_BY_ID = {
  ...
  "responsible-ai": { catalogOrder: 17, displayNumber: 16, blurbKey: "c.responsibleAi.blurb", metaKey: "c.responsibleAi.meta", topic: "responsible-ai", topicKey: "topic.responsibleAi", level: "beginner-to-intermediate", levelKey: "c.responsibleAi.level", format: "guided", formatKey: "cat.formatGuided", minutes: 650, hue: "var(--red)" },
