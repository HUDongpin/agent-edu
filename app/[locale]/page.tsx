...
export default async function Home({ params }: { params: Promise<{ locale: string }> }) {
  ...
  /* The home page's two client components — the progress panel and the three
     track buttons — read a handful of strings each. They are the only reason
     this route sends any dictionary to the browser at all. */
  return (
    <I18nScope messages={scopeMessages(messages, "home")}>
