...
- Runnable release fixture: `tests/fixtures/mcp-courseops/`
...
- Browser release evidence: `evidence/course-audits/mcp-browser-qa.md` and `output/playwright/mcp-course/`
