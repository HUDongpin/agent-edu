...
- A dependency-free Node.js CourseOps reference under `tests/fixtures/mcp-courseops`, including a pinned current-protocol stdio server, policy-aware client, synthetic fixture, lockfile, direct/expected-failure traces, eight automated tests, and a deterministic checksum-published archive.
